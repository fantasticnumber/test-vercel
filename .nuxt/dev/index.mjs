globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/cq/dev/_/test-vercel/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/cq/dev/_/test-vercel/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, createError, getQuery } from 'file:///home/cq/dev/_/test-vercel/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/cq/dev/_/test-vercel/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/cq/dev/_/test-vercel/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/cq/dev/_/test-vercel/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/cq/dev/_/test-vercel/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/cq/dev/_/test-vercel/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/cq/dev/_/test-vercel/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/cq/dev/_/test-vercel/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/cq/dev/_/test-vercel/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/cq/dev/_/test-vercel/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/cq/dev/_/test-vercel/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///home/cq/dev/_/test-vercel/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/cq/dev/_/test-vercel/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/cq/dev/_/test-vercel/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/cq/dev/_/test-vercel/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/cq/dev/_/test-vercel/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cq/dev/_/test-vercel","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cq/dev/_/test-vercel/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cq/dev/_/test-vercel/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cq/dev/_/test-vercel/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_wzaDDv = () => Promise.resolve().then(function () { return test$1; });
const _lazy_hhQuxC = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/test', handler: _lazy_wzaDDv, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_hhQuxC, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hhQuxC, lazy: true, middleware: false, method: undefined }
];
...
const test = defineEventHandler(async (event) => {
  var _a;
  if (((_a = event.node.req.method) == null ? void 0 : _a.toUpperCase()) !== "POST") {
    throw createError({
      statusCode: 405,
      data: "Post only!"
    });
...
const getClientManifest = () => import('/home/cq/dev/_/test-vercel/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/cq/dev/_/test-vercel/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
